...
function Page() {
  ...
  const [formTitle] = useState("WICF Prayer request");
  ...
  // async function onFormSubmit2(values) {
  //   console.log("submit", values);
  //   try {
  //     values.form = "prayer_request";
      ...
      >
        ...
        {isDone !== true ? (
          ...
          >
            ...
            >
              <span>
                Feel free to send all your prayer requests, we will pray with
                and for you, God bless you!
              </span>
              <br />
            </Paragraph>
            <Form.Item name="name" label="First and Last Name (Optional)">
              <Input allowClear />
            </Form.Item>
            <Form.Item
              name="contact_info"
              label="Contact details [Phone-number/Wechat] (Optional)"
            >
              <Input allowClear />
            </Form.Item>
            <Form.Item
              ...
              rules={[
                {
                  required: true,
                  message:
                    "Please enter your prayer request (Atleast 10 characters)",
                  min: 10,
                },
              ]}
            >
