...
function Page() {
  ...
  const [formTitle] = useState(
    `Brown Bag Registration ` + new Date().getFullYear(),
  );
  ...
  const request_prayerSubmit = api.prayer.create_bb.useMutation();
        ...
        {isDone !== true ? (
          ...
          >
            <Paragraph
              ...
              `}
            >
              <span>{`Registration for Brown Bag`}</span>
              <br />
            </Paragraph>
            <Form.Item
              name="first_name"
            ...
            <Form.Item name="institution" label="School / Institution">
              <Select
                options={[
                  ...shared_universities2_options,
